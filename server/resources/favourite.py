...
profile_bp = Blueprint('Favourite',__name__,url_prefix='/favourite')
profile_api = Api({favourite_bp})
...
favourites_api.add_resource(FavouriteResource, '/<int:id>')
favourites_api.add_resource(FavouriteListResource, '')